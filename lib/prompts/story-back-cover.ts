...
const COMPOSITION_RULE =
  "Composition: just two things — a soft colored background covering the canvas edge-to-edge, and one elegant tagline floating in the middle. No characters, no scene, no upper illustration zone, no barcode rectangle. Calm and spacious.";
...
export const STORY_BACK_COVER_TODDLER_SYSTEM = [
  ...
  "Output: a single coherent full-bleed picture-book back cover — soft colored background plus centered tagline.",
].join(" ");
